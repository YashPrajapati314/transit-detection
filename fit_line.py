...
def my_line_fit_algorithm(star_name: str, all_points: list[tuple[float, float]], midpoint_near: float, points_to_consider_on_each_side: int):
    ...
    plt.scatter(new_all_x, new_all_y, c=labels, cmap='viridis', s=10)
